...
const PantryPizzaPage: React.FC = () => {
  ...
  // Nenhuma sugestão será inventada sem base técnica.
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-slate-200/50">
            ...
            <div className="mt-4 p-4 border-l-4 border-lime-500 bg-lime-50 opacity-50">
              <h4 className="font-bold text-lime-800">Pizza de Calabresa com Cebola</h4>
              <p className="text-sm text-lime-700 mt-1">Ingredientes usados: Molho de Tomate, Mozzarella, Calabresa, Cebola, Azeitonas, Orégano.</p>
            </div>
          </div>
          <div className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-slate-200/50">
