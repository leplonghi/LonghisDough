        ...
        <MyLabLayout activePage="mylab/objetivos" onNavigate={onNavigate}>
            <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="mt-1 text-sm text-neutral-500">Set small challenges to evolve your baking skills.</p>
                </div>
            ...
            <div className="space-y-8">
                {/* AI Suggestions */}
                <div>
                    <h3 className="text-lg font-medium mb-3 flex items-center gap-2"><SparklesIcon className="h-5 w-5 text-lime-500" /> AI Suggestions</h3>
