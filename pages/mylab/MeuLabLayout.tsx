...
const MyLabLayout: React.FC<MyLabLayoutProps> = ({ children, activePage, onNavigate }) => {
  const navItems = [
    ...
    { page: 'mylab/massas' as Page, label: 'Minhas Massas', icon: <DocumentDuplicateIcon className="h-5 w-5" /> },
    { page: 'mylab/fornadas' as Page, label: 'Minhas Fornadas', icon: <BeakerIcon className="h-5 w-5" /> },
    { page: 'mylab/farinhas' as Page, label: 'Minhas Farinhas', icon: <FlourIcon className="h-5 w-5" /> },
    { page: 'mylab/diario-sensorial' as Page, label: 'Diário Sensorial', icon: <BookOpenIcon className="h-5 w-5" /> },
    { page: 'mylab/comparacoes' as Page, label: 'Comparações', icon: <SparklesIcon className="h-5 w-5" /> },
    { page: 'mylab/insights' as Page, label: 'Insights', icon: <ChartBarIcon className="h-5 w-5" /> },
    { page: 'mylab/timeline' as Page, label: 'Linha do Tempo', icon: <ClockIcon className="h-5 w-5" /> },
