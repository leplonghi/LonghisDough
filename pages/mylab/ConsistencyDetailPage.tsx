    ...
    return (
        <MyLabLayout activePage="mylab/consistency" onNavigate={onNavigate}>
             <div className="mb-6">
                ...
                <p className="mt-1 text-sm text-neutral-500">Summary of your controlled test series.</p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
                        ...
                        ) : <p className="text-sm text-center text-neutral-500 py-4">No bakes associated yet.</p>}
                    ...
                    <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
                        ...
                        {isEditingNotes ? (
                             ...
                             <div onClick={() => setIsEditingNotes(true)} className="cursor-pointer prose-sm text-neutral-600 min-h-[5rem]">
                                {notes || <p className="italic">Click to add notes...</p>}
                            </div>
                        )}
                    </div>
                    ...
                    <div className="rounded-xl border-2 border-dashed border-neutral-300 p-6 text-center">
                        ...
                        <p className="mt-1 text-sm text-neutral-500">Coming soon: AI will analyze your bake results and generate a comparative report.</p>
                    </div>
                </div>
                ...
                <div className="lg:col-span-1">
                     <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-6 shadow-sm sticky top-24">
                        ...
                        <div className="space-y-3 text-sm">
                            <p><strong className="text-neutral-500">Variable:</strong> {series.parameters.variable}</p>
                             <div>
                                <strong className="text-neutral-500">Steps tested:</strong>
