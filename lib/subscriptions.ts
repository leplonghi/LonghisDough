 ...
 */
export function isProUser(user: AppUser | null | undefined): boolean {
 ...
 */
export function isFreeUser(user: AppUser | null | undefined): boolean {
 ...
 */
export function remainingTrialDays(user: AppUser | null | undefined): number {
