...
const FundamentalsPage: React.FC<FundamentalsPageProps> = ({ onNavigate }) => {
    const topics = [
        ...
        { page: 'learn/sugars-malts-enzymes', title: 'Sugars & Enzymes', description: 'How sugars, malts, and enzymes influence fermentation, color, and flavor.', icon: <SparklesIcon className="h-8 w-8" /> },
        { page: 'learn/water', title: 'Water in Dough', description: 'The science of hardness, minerals, and the impact of water on gluten.', icon: <WaterIcon className="h-8 w-8" /> },
