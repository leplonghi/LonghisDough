        ...
        <div className="mt-10">
            ...
            <div className="space-y-4 rounded-lg border border-slate-200 bg-white p-4 sm:p-6">
                ...
                {mismatchWarnings.map((warning, index) => (
                    <div key={`warn-${index}`} className="flex items-start gap-3 rounded-md bg-yellow-50 p-3 text-yellow-900 ring-1 ring-inset ring-yellow-200">
                ...
                {professionalNotes.map((note, index) => (
                    <p key={`note-${index}`} className="text-sm text-slate-600 pl-8 relative">
