...
import { DoughConfig, FermentationTechnique, YeastType, FormErrors } from '../../../types';
import FormSection from '../AccordionSection';
import { FermentationIcon } from '../../IconComponents';
...
const FermentationSection: React.FC<FermentationSectionProps> = ({ config, onConfigChange, isBasic, errors }) => {
