                                        ...
                                        <div className="overflow-x-auto">
                                            <table className="min-w-full text-sm text-left">
                                                <thead className="bg-slate-50">
                                                    <tr>
                                                        <th className="px-6 py-3 font-medium text-slate-600">Tamanho</th>
                                                        <th className="px-6 py-3 font-medium text-slate-600 text-right">Molho (g)</th>
                                                        <th className="px-6 py-3 font-medium text-slate-600 text-right">Queijo (g)</th>
                                                        <th className="px-6 py-3 font-medium text-slate-600 text-right">Cobertura (g)</th>
                                                        <th className="px-6 py-3 font-medium text-slate-600 text-right">Azeite Final (g)</th>
                                                    </tr>
                                                </thead>
