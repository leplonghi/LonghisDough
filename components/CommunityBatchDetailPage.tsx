            ...
            <div className="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-slate-200/50 sm:p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-6">
                        <h3 className="text-lg font-bold text-slate-800">{t('community_detail.recipe_params')}</h3>
                     ...
                     <div className="space-y-6">
                         <h3 className="text-lg font-bold text-slate-800">{t('community_detail.env_process')}</h3>
                         <dl className="grid grid-cols-2 gap-x-4 gap-y-6">
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-slate-200 pt-6">
                    <button onClick={() => onNavigate('community')} className="text-sm font-medium text-lime-600 hover:underline">
