...
const InsightsCharts: React.FC = () => {
  return (
    <div>
        <h2 className="text-xl font-bold text-slate-800 mb-4">Dough Trends</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Line Chart Placeholder */}
            <ChartCard title="Hydration Evolution (Last 10 Bakes)">
            ...
            <ChartCard title="Most Used Styles">
                <div className="h-40 flex flex-col justify-end gap-2 rounded-lg p-4">
                    <div className="flex items-end gap-4 h-full">
                        <div className="w-1/3 bg-lime-300 rounded-t-sm" style={{ height: '80%' }} title="Neapolitan"></div>
            ...
            <ChartCard title="Consistency Index">
