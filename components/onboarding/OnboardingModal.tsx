...
const OnboardingModal: React.FC<OnboardingModalProps> = ({ onStart, onSkip }) => {
  ...
  return (
    ...
    >
      <div className="relative mx-4 w-full max-w-lg rounded-2xl bg-white p-8 text-center shadow-xl sm:p-12">
        ...
        <div className="mt-10 flex flex-col-reverse gap-4 sm:flex-row sm:justify-center">
          ...
          <button
            onClick={onStart}
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-lime-500 py-3 px-6 text-base font-semibold text-white shadow-md transition-all hover:bg-lime-600 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-offset-2"
          >
