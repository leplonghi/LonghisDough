...
export const STYLES_DATA: DoughStyleDefinition[] = [
  ...
  },
  {
    ...
    country: 'France',
    year: '17th Century',
    origin: { country: 'France', region: 'Normandy', period: '17th Century' },
    isCanonical: true,
    source: 'official',
  ...
  },
  {
      ...
      country: 'Italy',
      year: '1980s (modern)',
      origin: { country: 'Italy', region: 'Rome', period: '1980s' },
      isCanonical: true,
      source: 'official',
  ...
  },
  {
    ...
    country: 'USA/France',
    year: 'Modern',
    origin: { country: 'USA', region: 'General', period: 'Modern' },
    isCanonical: true,
    source: 'official',
  ...
  },
  {
    ...
    country: 'Japan',
    year: '20th Century',
    origin: { country: 'Japan', region: 'Hokkaido', period: '20th Century' },
    isCanonical: true,
    source: 'official',
  ...
  },
  {
    ...
    country: 'USA',
    year: 'Modern',
    origin: { country: 'USA', region: 'New York', period: 'Modern' },
    isCanonical: true,
    source: 'official',
  ...
  },
  {
    ...
    country: 'Sweden/USA',
    year: '1920s',
    origin: { country: 'Sweden', region: 'General', period: '1920s' },
    isCanonical: true,
    source: 'official',
